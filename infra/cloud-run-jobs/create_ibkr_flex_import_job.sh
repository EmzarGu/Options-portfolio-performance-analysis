...
FLEX_SEND_MIN_INTERVAL_SECONDS="${IBKR_FLEX_SEND_MIN_INTERVAL_SECONDS:-6.5}"
FLEX_RATE_LIMIT_RETRIES="${IBKR_FLEX_RATE_LIMIT_RETRIES:-1}"
FLEX_RATE_LIMIT_BACKOFF_SECONDS="${IBKR_FLEX_RATE_LIMIT_BACKOFF_SECONDS:-65}"
...
COMMON_FLAGS=(
  ...
  --set-env-vars="OPTIONS_DATA_SOURCE=ibkr,IBKR_REPORT_SOURCE=firestore,IBKR_RAW_BUCKET=${RAW_BUCKET},IBKR_IMPORT_INCEPTION_DATE=${IMPORT_INCEPTION_DATE},IBKR_IMPORT_RECENT_OVERLAP_DAYS=${IMPORT_RECENT_OVERLAP_DAYS},IBKR_IMPORT_TO_OFFSET_DAYS=${IMPORT_TO_OFFSET_DAYS},IBKR_FLEX_SEND_MIN_INTERVAL_SECONDS=${FLEX_SEND_MIN_INTERVAL_SECONDS},IBKR_FLEX_RATE_LIMIT_RETRIES=${FLEX_RATE_LIMIT_RETRIES},IBKR_FLEX_RATE_LIMIT_BACKOFF_SECONDS=${FLEX_RATE_LIMIT_BACKOFF_SECONDS}"
