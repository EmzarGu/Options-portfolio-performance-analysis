...
9. Active and future cycle projections keep OTM linked-stock unrealized P&L as
   exposure only and include stock P&L at strike when an ITM call would dispose
   of the shares in that cycle.
